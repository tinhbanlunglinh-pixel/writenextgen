          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-6">
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="w-20 h-20 md:w-28 md:h-28 bg-white rounded-full border-4 border-white/20 p-1.5 shadow-lg flex items-center justify-center overflow-hidden shrink-0 ring-4 ring-white/10">
                ...
                <div className="text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-2 mb-2 group">
                     ...
                     <span className="text-[10px] font-black text-white uppercase tracking-[0.3em] whitespace-nowrap">WriteScore AI System</span>
                  </div>
                  <h1 className="text-2xl md:text-4xl font-sans font-black text-white tracking-tight whitespace-nowrap uppercase">
                    Nextgen English
                  </h1>
                </div>
              </div>
              ...
              <button 
                ...
                className={`p-3 rounded-xl transition-all flex flex-col items-center gap-1 group shadow-sm border-2 ${!apiKey ? 'bg-red-500 border-red-400 hover:bg-red-600 animate-pulse' : 'bg-white/10 border-white/20 text-white hover:bg-white/20'}`}
              >
                ...
                {!apiKey ? (
                  <span className="text-[8px] font-black text-white whitespace-nowrap">Lấy API key để sử dụng app</span>
                ) : (
                  <span className="text-[8px] font-black text-white/80 whitespace-nowrap">API Key đã sẵn sàng</span>
                )}
              </button>
            </div>
            
            <p className="text-white/90 font-sans text-base md:text-lg font-black tracking-wide">
